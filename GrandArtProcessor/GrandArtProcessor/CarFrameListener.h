#ifndef CARFRAMELISTENER_H
#define CARFRAMELISTENER_H
...
class CarFrameListener : public ExampleFrameListener,OIS::KeyListener,OIS::MouseListener,OIS::JoyStickListener
{
private:
	bool g_exit;
	float g_totalTime;
	...
	MyWriteToFile *wtf;
public:
	CarFrameListener(Ogre::RenderWindow *win,Ogre::Camera* cam,GAPMainManager* mainMgr);
